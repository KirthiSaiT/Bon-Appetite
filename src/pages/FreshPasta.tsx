...
const FreshPasta = () => {
  ...
  const handleSubmitOrder = () => {
    ...
    const templateParams = {
      ...
      message: `
        You have a new fresh pasta order!
  ...
  const freshPastaTypes = [
    {
      ...
      price: "₹180 per 250g",
      image: "/lovable-uploads/fresh pasta.jpg",
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {freshPastaTypes.map((pasta, index) => (
          ...
          <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-xl">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-800">Order Fresh Pasta</h3>
                <button 
                  onClick={closeModal}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-4">
              Thank you for your fresh pasta order! We'll confirm within 24 hours.
            </p>
          </div>
        </div>
      )}
