...
const FreshSaladBowls = () => {
  ...
  const [selectedSalad, setSelectedSalad] = useState<{name: string, description: string, price: string, image: string} | null>(null);
  ...
  const handleOrderClick = (salad: {name: string, description: string, price: string, image: string}) => {
  ...
  const handleSubmitOrder = () => {
    ...
    const templateParams = {
      ...
      message: `
        You have a new fresh salad bowl order!
        Product: ${selectedSalad?.name}
        Price: ${selectedSalad?.price}
        Quantity: ${orderForm.quantity}
        Description: ${selectedSalad?.description}
  ...
  const freshSaladBowls = [
    {
      ...
      price: "₹280",
      image: "/lovable-uploads/fresh salad.jpg",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {freshSaladBowls.map((salad, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm mb-4 leading-relaxed">{salad.description}</p>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-lg font-bold text-orange-600">{salad.price}</span>
                  </div>
                  
                  <button
                    onClick={() => handleOrderClick(salad)}
      ...
      {showOrderModal && selectedSalad && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-xl">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-800">Order a Salad Bowl</h3>
                <button 
                  onClick={closeModal}
            ...
            <div className="p-6">
              <div className="bg-orange-50 rounded-lg p-4 mb-6">
                <h4 className="font-semibold text-orange-800 mb-1">{selectedSalad.name}</h4>
                <p className="text-sm text-orange-700">{selectedSalad.price}</p>
                <p className="text-xs text-orange-600 mt-1">{selectedSalad.description}</p>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-8 max-w-md w-full text-center">
            ...
            <p className="text-gray-600 mb-4">
              Thank you for your salad order! We'll contact you soon.
            </p>
          </div>
        </div>
      )}
